				...
				<div class="col-md-9">
					<div class="card">
						<div class="card-body">
							...
							$qry= "SELECT * FROM feedback WHERE eid='".$id."'";
							...
							if(mysqli_num_rows($rs)>0)
							{
								...
								{
									$u_id=$row['id'];
									$qry_u="SELECT * FROM user_tbl where id=$u_id";
									$rs_u=mysqli_query($con,$qry_u);
									$row_u=mysqli_fetch_assoc($rs_u);


									?>
									<div class="container box" style="width:600px; height: 100px;">
										<row>
											<div class="col-lg-2"><br>
												 	<?php 
							       		if(file_exists($row_u['profile_pic']))
							       		{
							       	?>
							       <img src="<?php echo $row_u['profile_pic'];?>" class="img-circle img-thumnail color-primrry" height="70" width="70">
							  <?php }
							  		else
							  		{?>
							  			 <img src="images/farmer/default.jpg" class="img-circle img-thumnail color-primrry" height="70" width="70">
							  	 <?php	}
							  ?>
