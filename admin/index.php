...
<body class="login-img3-body">
  ...
  <div class="container">
    ...
    <form class="login-form" action="loginprocess.php" method="post">
      <div class="login-wrap">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" placeholder="Username" name="txt_un"autofocus>
        </div>
        <div class="input-group">
          <spa

          n class="input-group-addon"><i class="icon_key_alt"></i></span>
    ...
    <!--CHECKLOGIN-->
        ...
        <a href="dashboard.php" class="btn btn-primary btn-lg btn-block">Sign Up</a>-->
      </div>
    </form>
