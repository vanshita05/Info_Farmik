          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="get" action="addstateprocess.php">
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">State name<span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="cname" name="state_name" type="text" required />
                      </div>
                    </div>
                    <div class="form-group">
