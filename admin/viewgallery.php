  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> VIEW GALLERY</h3>
...
?>
        ...
        <tr>
            ...
            <td><img src="<?php echo $row['photos'];?>"width="100" height="100"></td>
            
            <td><?php echo $row['doi']?></td>
            <td><?php echo $row['dou']?></td>
            
            <td><a href="editgallery.php?id=<?php echo $row['med_id']?>">Edit</a></td>
            <td><a href="deletegallery.php?id=<?php echo $row['med_id']?>">Delete</a></td>
        </tr>
        <?php
              }
        }
