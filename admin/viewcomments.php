...
$qry="SELECT * FROM `comment` WHERE `Isactive`=1 OR `Isactive`=0";
 ...
 <?php
        ...
        <tr>
            ...
            <td>
                ...
                // $qry1="SELECT * FROM `user_tbl` WHERE'id'='".$id."'";
                // echo $qry1;
            ...
            <td>
                <?php
                    ...
                    $sql = "SELECT * FROM `expert_tbl` WHERE `eid`='".$id1."'";
            ...
            <td><a href="deletefeedback.php?t_id=<?php echo $row['cid']?>">Delete</a></td>
        </tr>
        <?php
            }
            }
