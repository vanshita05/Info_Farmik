...
$qry="SELECT * FROM `expert_tbl` WHERE `Isactive`=2 ";
...
?>
        ...
        <tr>
            ...
            <td><img src="../<?php echo $row['certi'];?>"width="100" height="100"></td>
            
            
            <td><?php echo $row['Isactive']?></td>
            <td><?php echo $row['doi']?></td>
            <td><?php echo $row['dou']?></td>
            <td><a href="statuschange.php?id=<?php echo $row['id']?>">Change</a></td>
            <td><a href="edituser.php?id=<?php echo $row['id']?>">Edit</a></td>
            <td><a href="deleteuser.php?id=<?php echo $row['id']?>">Delete</a></td>
            <td><a href="verifycerty.php?id=<?php echo $row['eid'];?>"><button  name="verify"  class="btn-btn-primary" >verify</button></a></td>
        </tr>
        <?php
              }
        }
        ?>    
                     ...
                     <!--view user in table form code start-->
 
                <!--view user in table form code end-->
              </div>
