...
<body>
 ...
 <!--Mainsidebar end-->
  ...
  $qry = "SELECT * FROM city_tbl WHERE Isactive=1 OR Isactive=0";
        ...
        if(mysqli_num_rows($rs1)>0)
        {
          while($row1=mysqli_fetch_assoc($rs1))
          {
            ...
            <tr>
              ...
              <td><?php $state_i = $row1['state_id'];
                  $qry1="SELECT * FROM state_tbl WHERE `state_id`='".$state_i."'";
