          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="addgalleryprocess.php" enctype="multipart/form-data">
                    <div class="form-group ">
                      
                        <input class="form-control" id="cname" name="fileToUpload" type="file" required />
                      </div>
                    </div>
                    <br>
                    <div class="form-group">
                      <div class="col-lg-offset-2 col-lg-10">
                        <input class="btn btn-primary" type="submit" name="btn_sb" value="submit">
        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="addvideoprocess.php" enctype="multipart/form-data">
                    <div class="form-group ">
