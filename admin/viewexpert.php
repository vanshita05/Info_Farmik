...
$qry="SELECT * FROM `expert_tbl` WHERE `Isactive`=1";
...
?>
        ...
        <tr>
            ...
            <td><a href="statusexpert.php?id=<?php echo $row['eid']?>">Change</a></td>
            <td><a href="editexpert.php?id=<?php echo $row['eid']?>">Edit</a></td>
            <td><a href="deleteexpert.php?id=<?php echo $row['eid']?>">Delete</a></td>
        </tr>
        <?php
