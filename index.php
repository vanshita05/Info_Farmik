...
<head>
		...
		<title>Info Farmic &amp; Eco Farm </title>
				...
				<div data-src="images/home/bgh1.jpg">
					<div class="camera_caption">
						<div class="container">
							...
							<a href="newregistration.php" class="tran3s active round-border wow fadeInLeft animated hvr-shutter-out-horizontal-two" data-wow-delay="1s">Farmer Registration</a>
							<a href="registration.php" class="tran3s active round-border wow fadeInLeft animated hvr-shutter-out-horizontal-two" data-wow-delay="1s">Expert Registration</a>
							<a href="login.php" class="tran3s round-border wow fadeInRight animated hvr-shutter-out-horizontal-two" data-wow-delay="1s">Login</a>
						</div> <!-- /.container -->
					</div> <!-- /.camera_caption -->
				</div>
            ...
            <section class="farm-fresh">
            	<div class="container">
            		<div class="row">
            			...
            			<div class="col-md-6 col-xm-12">
            				<img src="images/b1.jpg" height="350px" width="550px" alt="img">
            			</div><!-- /#col -->
            		</div><!-- /#Row -->
            	</div><!-- /#container -->
            </section><!-- /#farm-fresh -->
        		    ...
        		    <div class="gallery_item_wrapper row" id="mixitup_list">		
	        			...
	        			<div class="col-md-4 col-xs-6 mix Fruits Vegetables">
	        			    <div class="Product tran3s">
		        				...
		        				<div class="value-info">
		        					<h4><a href="#" class="tran3s">Dr.Sunil Kumar</a></h4>
		        			    	<h6 class="">Expert</h6>
		        			    </div><!-- value-info -->
	        			    </div> <!-- Product -->
	        			</div> <!-- col -->
	        			...
	        			<div class="col-md-4 col-xs-6 mix Juices Beef"> 
	        		        ...
	        		        <div class="Product tran3s">
		        				...
		        				<div class="value-info">
		        					<h4><a href="#" class="tran3s">Joyus Nicolus</a></h4>
		        					<h6 >Expert</h6>
		        			    </div><!-- value-info -->
	        			    </div> <!-- Product -->
	        			</div> <!-- col -->
	        			...
	        			<div class="col-md-4 col-xs-6 mix Fruits Milk"> 
	        		        ...
	        		        <div class="Product tran3s">
		        				...
		        				<div class="value-info">
		        					<h4><a href="#" class="tran3s">S.Jaykumar</a></h4>
