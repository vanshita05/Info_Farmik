...
<body>	
	...
	<center>
 	...
 	<form action="cropreg.php" method="POST" class="form-horizontal">
 		<table>
 			...
 			<tr>
 				...
 				<td>
 					<input type="text" name="txt_fn" class="form-control" width="500">
 				</td>
 			</tr>
 		</div>
 			<tr>
 				...
 				<td>
 					<input type="text" name="txt_ln" class="form-control">
 				</td>
 			</tr>
 			<tr>
 				<td>
 			...
 			<tr>
 				...
 				<td>
 					<input type="radio" name="txt_gen" value="M" checked>Male
 					<input type="radio" name="txt_gen" value="F">Female
 				</td>
 			</tr>
 			<tr>
 				<td>
 			...
 			<tr>
 				...
 				<td>
 					<textarea rows="8" cols="20" name="txt_add"></textarea>	
 				</td>
 			</tr>
 			<tr>
 				<td>
 		...
 		<tr>
 			...
 			<td>
 				<input type="text" name="txt_cpass"><br><br>
 			</td>
 		</tr>
 	</table>
 	<b>Select Categories :</b>
 	<div class="buttonDiv">
		<button type="submit" name="crop" value="crop" class="hvr-shutter-out-horizontal-two round-border">Crop</button>
		<button type="submit" name="animal" value="animal" class="hvr-shutter-out-horizontal-two round-border">Animal</button>
	</div>
