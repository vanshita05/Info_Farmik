...
<head>
		...
		<title>Farm Fresh - Organic Food &amp; Eco Farm .php Template</title>
			        		...
			        		<nav class="navbar navbar-default float_right">
							   ...
							   <div class="collapse navbar-collapse float_left" id="navbar-collapse-1">
							     <ul class="nav navbar-nav">
							       ...
							       <li class="dropdown-holder"><a href="exprofile.php">Ask to Expert</a>
							       </li>
				    ...
				    <div class="row">
				      	<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
				      		<div class="contact-us-section">
				      			<h2>Ask question</h2>
				      			<form action="questionprocess.php" method="post" class="theme-form-two form-validation" enctype="multipart/form-data">
				      				<div class="row">
				      					<?php $id=$_GET['id'];?>

				      				<div class="col-md-12 col-sm-12">
				      						<textarea placeholder="Ask Your Question" name="question">
				      						</textarea>
				      					</div><!--/.column-->
				      				</div><!--/.row-->
				      				...
				      				<div class="row">
				      					<div class="col-md-6 col-sm-12">
				      						...
				      						<input type="file" placeholder="Attach file" name="fileToUpload">
				      					</div><!-- /.col -->
				      					<div class="col-md-6 col-sm-12">
				      				...
				      				<div class="buttonDiv">
										<input class="hvr-shutter-out-horizontal-two round-border" type="submit" name="btn_sb" value="Submit">
								    </div><!-- /buttonDiv -->
				      			</form> <!-- /.theme-form-two -->
