				    ...
				    <div class="row">
				      	<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
				      		<div class="contact-us-section">
				      			<h2>Signup  Here !..</h2>
				      			<form action="" class="theme-form-two form-validation" autocomplete="off">
				      				
				      				<input type="text" placeholder="Username" name="sub">
				      				<div class="row">
				      				...
				      				<div class="buttonDiv">
										<button class="hvr-shutter-out-horizontal-two round-border">Login</button>
								    </div><!-- /buttonDiv -->
				      			</form> <!-- /.theme-form-two -->
