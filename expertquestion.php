...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="images/jpg" sizes="56x56" href="images/logo/fab-icon.jpg">
								...
								<div class="col-md-10">
									<div class="container">
										...
										<div class="row">
											...
											<div class="col-sm-1">
												<div class="thumbnail">
													<img class="img-responsive user-photo" src="<?php echo $u_row['profile_pic'];?>" "width="100" height="100">
												</div><!-- /thumbnail -->
											</div><!-- /col-sm-1 -->
											...
											<div class="col-sm-4">
												<div class="panel panel-default">
													...
													<div class="panel-body">
														...
														<button class="btn btn-primary"><i class="fa fa-comment"></i>Comment</button><br/><br/>
														<textarea class="form-control" placeholder="Enter yout comment"></textarea>
