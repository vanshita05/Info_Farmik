...
<br>
<br>
		<form action="cropexpertsubmit.php" method="POST">
		<input type="text" name="txt_fn" value="<?php echo $fn;?>">
	<input type="text" name="txt_ln" value="<?php echo $ln;?>">
	<input type="text" name="txt_email" value="<?php echo $email;?>">
	<input type="text" name="txt_dob" value="<?php echo $dob;?>">
	<input type="text" name="txt_mobileno" value="<?php echo $mobileno;?>">
	<input type="text" name="state" value="<?php echo $state;?>">
	<input type="text" name="city" value="<?php echo $city;?>">
	<input type="text" name="txt_add" value="<?php echo $add;?>">
	<input type="text" name="txt_pass" value="<?php echo $pass;?>">
	<input type="text" name="txt_cpass" value="<?php echo $cpass;?>">
	<input type="text" name="txt_gen" value="<?php echo $gen;?>">
	<table>
		<tr>
			<td>
	...
	<center>
 	...
 	<form action="animalexpertsubmit.php" method="POST">
		<input type="text" name="txt_fn" value="<?php echo $fn;?>">
	<input type="text" name="txt_ln" value="<?php echo $ln;?>">
	<input type="text" name="txt_email" value="<?php echo $email;?>">
	<input type="text" name="txt_dob" value="<?php echo $dob;?>">
...
<?php
	...
	{
		header("location: cropexpertsubmit.php");
	}
	elseif(isset($_POST['btn_sb2']))
	{
		header("location: animalexpertsubmit.php");
	}
?>