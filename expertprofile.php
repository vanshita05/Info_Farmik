			...
			<div class="container box" >
				<row>
					<div class="col-lg-2"><br>
							   <img src="images\gallary\a1.jpg" class="img-circle img-thumnail color-primrry" height="90" width="90">
					  </div>

					  <div class="col-lg-10 col-md-8 col-sm-12 col-xs-12 ">
					  	Name:<?php echo $row['firstname']." ".$row['lastname'];?><br>
					  	Experties:<?php echo $row['specializedin'];?><br>
					  	Contact:<?php echo $row['mobileno'];
					  					$eid = $row['eid'];
					  	?><br>
					  	<input type="button" name="btn1" class="btn btn-primary" data-toggle="modal" data-target="#dd" value="Ask Question">
