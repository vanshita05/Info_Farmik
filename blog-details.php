			        		...
			        		<nav class="navbar navbar-default float_right">
							   ...
							   <div class="collapse navbar-collapse float_left" id="navbar-collapse-1">
							     <ul class="nav navbar-nav">
							       ...
							       <li class="dropdown-holder active"><a href="#">Blog</a>
							       		<ul class="sub_menu">
					...
					<div class="row">
				        <div class="blog-images-categories imges-categories col-md-8 col-xs-12 float_right">
					        <div class="left-blog">
						    	<div class="img images-hover">
									<img src="images/blog/blog-details1.png" alt="images" class="tran3s">
								...
								<div class="text-blog">
									...
									<div class="float_left img-box"><img src="images/blog/blog-details2.jpg" alt="img"></div>
									<div class="float_right img-box"><img src="images/blog/blog-details3.jpg" alt="img"></div>
									<div class="clear_fix"></div>
					    ...
					    <div class="left-about">
							...
							<ul>
								...
								<li><a href="blog.php" class="tran3s">Garden</a></li>
					    ...
					    <div class="left-about archive-post">
							...
							<ul>
								...
								<li><a href="blog.php">October 2016<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(1)</span></a></li>
