...
.container .details p{
						...
						<nav class="navbar navbar-default float_right">
							...
							<div class="collapse navbar-collapse float_left" id="navbar-collapse-1">
								<ul class="nav navbar-nav">
									...
									<li class="dropdown-holder"><a href="exprofilemg.php">Profile</a>
									</li>
  ...
  <div class="row">
    <div class="col-md-4 img">
      <img src="<?php  echo $row['profile_pic']?>"  class="img-rounded" width="400" heigth="500">
    </div>
    ...
    <div class="col-md-6 details">
      ...
      <table class="table table-bordered">
			        ...
			        <tbody>
				    			...
				    			{
				    				$qry_c="SELECT * FROM crop_cat WHERE mobileno='".$mobileno."'";
				    				$rs_c= mysqli_query($con,$qry_c);
				    				$row_c= mysqli_fetch_assoc($rs_c);

				    				?>
				    			<tr>
				    				<td>Crop</td>
				    				<td><?php echo $row_c['crop_name']?></td>
				    			</tr>
				    			<tr>
				    				<td>Fertilizer</td>
				    				<td><?php echo $row_c['fertilizer']?></td>
				    			</tr>
				    			<tr>
				    				<td>Type of Soil</td>
				    				<td><?php echo $row_c['type of soil']?></td>
				    			</tr>
				    			<tr>
				    				<td>TotalTurnOver</td>
				    				<td><?php echo $row_c['totalturnover']?></td>
				    			</tr>
				    			<tr>
				    				<td>Water Supply Technic</td>
				    				<td><?php echo $row_c['water_tech']?></td>
				    			</tr>
				    			<tr>
				    				<td>Water Supply Time</td>
				    				<td><?php echo $row_c['watertime']?></td>
				    			</tr>
				    		...
				    		<?php
				    			...
				    			{
				    				$qry_a="SELECT * FROM animal_cat WHERE mobileno='".$mobileno."'";
				    				$rs_a= mysqli_query($con,$qry_a);
				    				$row_a= mysqli_fetch_assoc($rs_a);

				    			?>
				    			<tr>
				    				<td>Animal</td>
				    				<td><?php echo $row_a['animal'];?></td>
				    			</tr>
				    			<tr>
				    				<td>Animal Gender</td>
				    				<td><?php echo $row_a['gender'];?></td>
				    			</tr>
				    			<tr>
				    				<td>Animal DOB</td>
				    				<td><?php echo $row_a['dob']?></td>
				    			</tr>
				    			<tr>
				    				<td>Daily Food</td>
				    				<td><?php echo $row_a['food type']?></td>
				    			</tr>
				    			<tr>
				    				<td>What it Produce</td>
				    				<td><?php echo $row_a['returnfood']?></td>
				    			</tr>
				    			<tr>
				    				<td>Quantity[per day]</td>
				    				<td><?php echo $row_a['quantity of food']?></td>
				    			</tr>
    ...
    <a href="reply.php?id=<?php echo $row['id']?>">  	<input type="submit" name="reply" class="btn btn-primary" value="Reply"></a>
    </div>
  </div>
</div></div>
		            </div>
