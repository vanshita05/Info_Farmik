				    ...
				    <div class="row">
				      	<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
				      		<div class="contact-us-section">
				      			<h2>Give Reply</h2>
				      			<form action="replyprocess.php" method="post" class="theme-form-two form-validation" enctype="multipart/form-data">
				      				<div class="row">
				      				...
				      				<div class="col-md-12 col-sm-12">
				      						<textarea placeholder="Write your reply" name="reply">
				      						</textarea>
				      					</div><!--/.column-->
				      				</div><!--/.row-->
