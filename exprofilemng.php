		    ...
		    <div class="card">
		        <div class="card-body">
		            ...
		            <div class="row">
	                 	<div class="container">
  <div class="row">
  <form action="updateimg.php" method="post" enctype="multipart/form-data">  <div class="col-md-4 img">
      ...
      <table class="table table-bordered">
				        ...
				        <tbody>
				    			...
				    			<tr>
				    				...
				    				<td><input type="text" name="spec" value="<?php echo $row['specialization'];?>" style="border-style: none;"></td>
				    			</tr>
				    			<tr>
				    				<td>mobileno</td>
